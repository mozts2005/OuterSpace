...
class FleetRedirectionDlg:
	...
	def onRedirect(self, widget, action, data):
	...
	def createUI(self):
		...
		ui.TitleButton(self.win, layout = (35, 27, 5, 1), text = _('Redirect'), action = 'onRedirect')
		ui.TitleButton(self.win, layout = (30, 27, 5, 1), text = _('Redirect OFF'), action = 'onRedirectOFF')
		ui.TitleButton(self.win, layout = (25, 27, 5, 1), text = _('Cancel'), action = 'onCancel')
		ui.Title(self.win, id = 'vStatusBar', layout = (0, 27, 25, 1), align = ui.ALIGN_W)
